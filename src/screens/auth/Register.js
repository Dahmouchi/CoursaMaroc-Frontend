...
export default function Register() {
    ...
    const handleLogin = async () => {
      try {
        const response = await axios.post("http://192.168.1.14:8000/api/register", {
          phone: phoneNumber,
          password: password,
          name: name,
        },
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View >
        ...
        <Text style={styles.signUpText}>لديك حساب؟<TouchableOpacity onPress={() => navigation.navigate('Login')}><Text style={styles.txtpart}> سجل الدخول</Text></TouchableOpacity></Text>
      </View>
    </SafeAreaView>
  );
}
